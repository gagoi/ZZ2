...
/*
TEST_CASE("Animal1") {
    const char * nom = "Pikachu";
    int          age = 10;
    Animal a(nom, age);

    REQUIRE( nom == a.getNom());
    REQUIRE( age == a.getAge());
}*/

/*
TEST_CASE("vache") {
    const char * nom  = "Claudette";
    int          age  = 5;
    Animal * uneVache = new Mouton(nom, age);

    REQUIRE( nom == uneVache->getNom());
    REQUIRE( age == uneVache->getAge());
...
/*
TEST_CASE("mouton") {
    const char * nom  = "Jean-Louis";
    int          age  = 6;
    Animal * unMouton = new Mouton(nom, age);

    REQUIRE( nom == unMouton->getNom());
    REQUIRE( age == unMouton->getAge());
...
/*
TEST_CASE("cris") {
    Animal * unMouton = new Mouton("JL", 6);
    Animal * uneVache = new Vache("Cloclo", 5);
    ...
    REQUIRE( "MEUH!" == ss1.str() );
    REQUIRE( "MIAOU" == ss2.str() );
