...
AppWizard a créé cette application TP1 pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application TP1.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) TP1.pch et un fichier de type précompilé nommé StdAfx.obj.
